...
if __name__ == '__main__':
    ...
    for bins in bins_list:
        ...
        df.loc[len(df)] = ["Discreet", "", cost_discreet, bins]
        ...
        for order in range(1,30):
            with warnings.catch_warnings():
                ...
                try:
                    ...
                    continue
        df.loc[len(df)] = ["Polynomial", best_order, best_cost, bins]
        ...
        cost = compute_cost(cdf, testing)
        df.loc[len(df)] = [distribution.name, "", cost, bins]
